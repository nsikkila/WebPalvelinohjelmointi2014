...
Testiympäristön migraatiot on mahdollista suorittaa komennolla <code>rake db:migrate RAILS_ENV=test</code>, suoritetaan kuitenkin testiympäristön ajantasaistaminen yleisemmin käytetyn komennon
